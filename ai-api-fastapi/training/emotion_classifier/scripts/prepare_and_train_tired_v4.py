# 파일: prepare_and_train_tired_v4.py
# 역할: TIRED 데이터 보강 후 6-class 감정 분류 모델 학습
# 실행: python scripts/prepare_and_train_tired_v4.py
...
ARTIFACTS_DIR = BASE / "artifacts" / "tired_v4"
...
train_df.to_csv(PROCESSED_DIR / "train_tired_v4.csv", index=False)
valid_df.to_csv(PROCESSED_DIR / "valid_tired_v4.csv", index=False)
...
print("\n=== 학습 시작 ===")
trainer.train(resume_from_checkpoint=str(ARTIFACTS_DIR / "checkpoint-8304"))
...
eval_path = BASE / "artifacts" / "evaluation" / "valid_metrics_tired_v4.json"
